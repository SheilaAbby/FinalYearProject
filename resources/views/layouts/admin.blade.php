            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="course">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{url('/view_courses')}}"> Current Courses </a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="general-pages">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('add_units')}}"> Add Unit </a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{route('view_units')}}"> View Units </a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#performance" aria-expanded="false" aria-controls="student">
                    ...
                    <div class="collapse" id="performance">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{route('view_performance')}}"> View Performance </a></li>
...
<script>
    $('div.alert').not('.alert-important').delay(5000).hide(4000);
</script>
